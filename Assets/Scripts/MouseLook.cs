...
[AddComponentMenu("Intro PRG/RPG/Mouse Look")]//adding Mouse Look new component in the "add component" buttons
...
//Creating an enum out side the script and making it public means it can be asessed anywhere in any script with out reference
    ...
    //Note: We are able to make unlimited "else if" (depending on how many situations we have)
